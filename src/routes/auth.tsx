...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in or create an account on HomeTrace, Nigeria's verified property marketplace." },
      ...
      <div className="hidden bg-primary p-12 text-primary-foreground md:flex md:flex-col md:justify-between">
        ...
        <div className="space-y-4">
          ...
          <p className="max-w-md text-primary-foreground/80 text-pretty">
            Save favorites, chat directly with vetted agents, schedule inspections and submit offers — all in one place.
          </p>
        </div>
...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" className="size-4" aria-hidden>
      ...
      <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.75c-.99.66-2.24 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
